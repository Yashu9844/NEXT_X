...
<Link href='/'>
     ...
     {
      session && (
        <div className="flex text-gray-700 text-sm items-center cursor-pointer p-3 hover:bg-gray-100 rounded-full transition-all duration-200">
          <img src={session.user.image} alt="image" className='h-10 w-10 rounded-full xl:mr-2' />
